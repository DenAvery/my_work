(() => {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let search = function () {
            ...
            let closeBtn = document.querySelector('.header__search__block__search-form__closeBtn');

            searchBtn.addEventListener('click', function (e) {
                e.preventDefault();
                searchBlock.classList.toggle('search__adaptive--active');
                searchBtn.classList.add('header__search__btn--off');
            })
            ...
            closeBtn.addEventListener('click', function (e) {
                ...
                searchBtn.classList.remove('header__search__btn--off');
            })
        ...
        let burgerMove = function () {
            ...
            burger.addEventListener('click', function () {
                document.getElementById('menu').classList.add('burger-menu--active');
            })

            let burgerClose = document.getElementById('burger--close')
            burgerClose.addEventListener('click', function () {
                document.getElementById('menu').classList.remove('burger-menu--active');
            })
        ...
        document.querySelectorAll('.header__drop-menu__item__btn').forEach(item => {
            item.addEventListener('click', function () {
                let btn = this;
                let dropdown = this.parentElement.querySelector('.header__drop-menu__content-block');

                document.querySelectorAll('.header__drop-menu__item__btn').forEach(el => {
                    if (el != btn) {
                        el.classList.remove('active--btn');
                    }
                });

                document.querySelectorAll('.header__drop-menu__content-block').forEach(el => {
                    if (el != dropdown) {
            ...
            document.addEventListener('click', function (e) {
                let target = e.target;
                if (!target.closest('.header__drop-menu__list')) {
                    document.querySelectorAll('.header__drop-menu__content-block').forEach(el => {
                        el.classList.remove('active-list--item');
                    })
                    document.querySelectorAll('.header__drop-menu__item__btn').forEach(el => {
        ...
        $('.transferToLink').click(function (e) {
            e.preventDefault();
        ...
        function mobileScroll() {
            if (window.innerWidth < 650) {
                $('.catalog__artists-block__names__btn').click(function () {
        ...
        eventButton.addEventListener('click', function () {
            ...
            eventItems.forEach(function (item) {
                ...
                if (item.classList.contains('events__item--active')) {
        ...
        document.querySelectorAll('.catalog__top-content__btn').forEach(function (tabsBtnСountries) {
            ...
            tabsBtnСountries.addEventListener('click', function (e) {
                ...
                document.querySelectorAll('.catalog__top-content__btn').forEach(function (item) {
                    item.classList.remove('catalog__top-content__btn--active');
                })

                country.classList.add('catalog__top-content__btn--active');
        ...
        document.querySelectorAll('.catalog__artists-block__names__btn').forEach(function (tabsBtnArtists) {
            ...
            tabsBtnArtists.addEventListener('click', function (e) {
                ...
                document.querySelectorAll('.catalog__artists-block__names__btn').forEach(function (item) {
                    item.classList.remove('catalog__artists-block__names__btn--active');
                })

                btn.classList.add('catalog__artists-block__names__btn--active');
        ...
        // mobileSlider(events)
        const sliderContainer = document.querySelector('.events__mobileSlider__container');
